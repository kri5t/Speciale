...
\end{figure}
\todo{Ligesom set ved wind power production analysis. Tidligere pris og pris sammenhaeng. Individuelle tilgange til at udregne dette har vi ikke udregnet her. This analysis shows the use for calculated inputs. referer til \ref{sec:windProductionDev}}
The following graph shows something.
\todo{Insert graph that shows how it follows the last price.}
\begin{figure}[H]
\centering
