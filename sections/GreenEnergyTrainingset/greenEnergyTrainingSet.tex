...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\linewidth,natwidth=898,natheight=587]{billeder/windProductionTrimming.png}
...
\todo{the wind speed does not map directly to wind production --- it makes sense because we find the co-relation in the last 3 months}