...
It is obvious from Table~\ref{table:pearsonCoeficientWindProduction} that consumption and wind speed are the most influential factors. (ADD MORE LIKE DENSITY, DEW POINT, HUMIDITY, TIME OF DAY, ECT).
