...
\todo{Snak om mangel i datasettet i forhold til at kunne forudsige extreme outliers. Andre metoder til at forudsige extreme outliers. Er snakket om i paper testing paperet}
...
\todo{Snak om hvilket format dataen skal have. Hvis nogle af dine parametre er underrepraesenteret i datasettet, saa kan de blive umulige at forudsige, da vi kun kommer til at se saa faa af dem. Derfor er Matrix hovedsagligt godt, hvis man kan splitte noget data op i lige store grupper som fx. med tid, dage, maaneder etc. Se afsnit to i brians eksperiment analyse. Husk at forklare i forhold til vaegte og at den ikke vil faa den rigtige vaegt hvis fx 5 ikke findes i traeningssettet, men uden matrix vil kunne repraesenteres, hvis vi har 4 og 6}
