...
\subsection{Learning}
Training of the network network will be done with the \fnurl{Resilient Back-propagation algorithm}{http://en.wikipedia.org/wiki/Rprop}. It is faster than standard back propagation \cite{15} and is often used with the \fnurl{feedforward architecture}{http://en.wikipedia.org/wiki/Backpropagation} which we use here \cite{17}. The most significant reason for applying RPROP instead of traditional backpropagation is its performance and the ability to avoid local minima.
