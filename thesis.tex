...
This chapter will describe the modelling of the Artificial Neural Networks used for prediction of wind power and electricity prices. It will include the entire process from data collecting to the finished Artificial Neural Network.  
\label{ch:theANNs}
