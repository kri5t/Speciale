...
This chapter will analyse what influence the price and wind production. The analysis will contribute to locating the potential input parameters to be used in the Artificial Neural Network. 
\label{ch:theANNs}
